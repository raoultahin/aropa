<main>
    <div class="container1">
        <div class="row z-depth-1">
            <div class="col s12">
                <h2 class="header" style="margin-bottom: 30px;">Ajout membre OPR</h2>
                <div class="row">
                    <div class="input-field col s3">
                        <input disabled id="code_op" value="<?php echo $ficheOp->CODE_OP?>" type="text" class="black-text" >
                        <label class="blue-text" for="code_op">Code OPR</label>
                    </div>
                    <div class="input-field col s3">
                        <input disabled id="nom_op" value="<?php echo $ficheOp->NOM_OP?>" type="text" class="black-text">
                        <label class="blue-text" for="nom_op">Nom OPR</label>
                    </div>
                </div>
                <form method="post" action="<?php echo base_url()?>c_parametre/insert_opr_membre">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $(function() {
            $.ajax({
                type: 'GET',
                url: 'http://localhost/aropa/c_rest/liste_opb_and_union/<?php echo $ficheOp->ID_OP ?>',
